...
<?php
    $query = "SELECT * FROM uacs_inv ORDER BY id";
        ...
        <div class="row">
          ...
          <div class="card">
              <div class="card-header">
                <div class="col-xs-6">
                  <h3>UACS- Inventory</h3>
                </div>
                <div class="col-xs-6" style="float: right;">
                  <button button type="button" data-toggle="modal" data-target="#uacsInv" class="btn btn-block btn-primary btn-lg">
              ...
              <thead>
                  ...
                  <tbody>
                    <?php if(!empty($uacsInv)): ?>
                            <?php $no=1; foreach($uacsInv as $row): ?>
                            <tr>
                                <td><?= $no ?></td>
                                ...
                                <td>
                                    <div class="form-button-action">
                                        <label class="button">
                                            <button type="button" href="#editUacsInv" data-toggle="modal" class="btn btn-primary" onclick="editUacsInv(this)"
                                              data-id="<?= $row['id'] ?>"
...
<?php include 'templates/footer.php' ?>
    ...
    <div class="modal fade" id="uacsInv" data-backdrop="static">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <form method="POST" action="controller/add_uacs_inv.php" id="uacsForm" onsubmit="confirmSubmit1(event);">
                <div class="card-body">
                          <div class="row">
                              <div class="col-md-12">
    ...
    <div class="modal fade" id="editUacsInv" data-backdrop="static">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">UACS-Inventory Form</h4>
              ...
              <div class="modal-body">
              <form method="POST" action="controller/edit_uacs_inv.php" onsubmit="confirmSubmit(event);">
    ...
    function confirmDelete(event, id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: 'controller/delete_uacs_inv.php',
                    type: 'POST',
                    data: {id: id},
