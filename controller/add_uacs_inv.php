...
try {
    ...
    // Prepare the query
    $stmt = $conn->prepare("INSERT INTO uacs_inv (acct_title, code, date) VALUES (:acct_title, :code, CURRENT_TIMESTAMP)");
    ...
    $action = "Add";
    $details = "Added a new UACS-Inventory named: $acct_title"; 
    logActivity($action, $details);

    // Redirect to the uacs_inv.php page after successful insertion
