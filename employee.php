          ...
          <div class="card">
              <div class="card-header">
                ...
                <div class="col-xs-6" style="float: right;">
                  <button button type="button" data-toggle="modal" data-target="#addEmp" class="btn btn-block btn-primary btn-lg">
...
<div class="modal fade" id="addEmp" data-backdrop="static">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" action="controller/add_employee.php" onsubmit="confirmSubmit1(event);">
          <div class="card-body">
            <div class="row">
              <div class="col-md-12">
                <label>Name</label>
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <input type="text" style="text-transform:uppercase" class="form-control" id="desig" name="desig" required>
              </div>
              <div class="col-md-6">
                <label>Status</label>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <div class="modal-body">
              <form method="POST" action="controller/edit_employee.php" onsubmit="confirmSubmit(event);">
                <input type="hidden" id="id" name="id">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <label>Designation</label>
                                <input type="text" class="form-control" style="text-transform:uppercase" id="desig1" name="desig" required>
                            </div>
                            <div class="col-md-6">
                                <label>Status</label>
