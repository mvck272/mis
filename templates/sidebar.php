    ...
    <div class="sidebar">
      ...
      <?php if(isset($_SESSION['name']) && isset($_SESSION['user_type']) && $_SESSION['user_type']=='admin'): ?>
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="risPage.php" class="nav-link <?= $current_page=='risPage.php' ? 'active' : null ?>">
          ...
          <li class="nav-item" id="reports">
            <a href="#" class="nav-link <?= $current_page=='rsmi.php'  ? 'active' : null ?>">
            ...
            <ul class="nav nav-treeview <?= ($current_page=='rsmi.php') ? ' show' : null ?>">
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a href="rsmi.php" class="nav-link  <?= $current_page=='rsmi.php' ? 'active' : null ?>">
                <i class="far fa-circle nav-icon"></i>
                  <p>
                    RSMI
                  </p>
          ...
          <li class="nav-item" id="settings">
            <a href="#" class="nav-link <?= $current_page=='stock.php' || $current_page=='uacs_inv.php' || $current_page=='uacs_exp.php' || $current_page=='employee.php' || $current_page=='dept.php' || $current_page=='user.php' || $current_page=='actLog.php' || $current_page=='backup.php' ? 'active' : null ?>">
            ...
            <ul class="nav nav-treeview<?= ($current_page=='stock.php' || $current_page=='uacs_inv.php' || $current_page=='uacs_exp.php' || $current_page=='employee.php' || $current_page=='dept.php' || $current_page=='user.php' || $current_page=='actLog.php' || $current_page=='backup.php' ) ? ' show' : null ?>">
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a href="ics1.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>ICS Catergories</p>
                </a>
              </li>
      ...
      <?php if(isset($_SESSION['name']) && isset($_SESSION['user_type']) && $_SESSION['user_type']=='user'): ?>
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="risPage.php" class="nav-link <?= $current_page=='risPage.php' ? 'active' : null ?>">
            <i class="nav-icon fa fa-issuance"></i>
              <p>
                Issuances
              </p>
            </a>
